package kr.danbee.junsec.config;
...
//jun ㄴㅇㅀㄴㅇㅀ
import kr.danbee.junsec.handler.CustomLoginSuccessHandler;

@Configuration
@EnableWebSecurity
@RequiredArgsConstructor
public class SecurityConfig extends WebSecurityConfigurerAdapter { // 정적 자원에 대해서는 Security 설정을 적용하지 않음.
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().authorizeRequests()
                .antMatchers("/login", "/signup","/home", "/about").permitAll()   // /login, /signup 은 인증 안해도 접근 가능하도록 설정
